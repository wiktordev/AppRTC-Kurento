...
document.write("<script type='text/javascript' src='https://" + server + "/jWebrtc/bower_components/bootstrap/dist/js/bootstrap.min.js'></script>"); 
document.write("<script type='text/javascript' src='https://" + server + "/jWebrtc/bower_components/ekko-lightbox/dist/ekko-lightbox.min.js'></script>"); 
document.write("<script type='text/javascript' src='https://" + server + "/jWebrtc/bower_components/draggabilly/dist/draggabilly.pkgd.min.js'></script>"); 
